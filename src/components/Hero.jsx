  ...
  return (
    <div className='z-10'>
      <div className='w-[85%] mx-auto mt-10 xLl:mt-12 z-10  py-4 xl:px-[90px] xl:py-[90px] px-[18px] rounded-lg bg-[#1A1A1A] relative xl:rounded-[50px]'>
        ...
        <button className=' xl:mt-[80px] text-[12px] px-[20px] py-[7px] bg-gradient-to-r from-emerald-500 to-sky-500 rounded-full mt-[19px] xl:text-3xl xl:py-[33px] xl:px-[94px] '>Early Bird Tickets</button>
